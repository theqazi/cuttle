...
| Field          | Value                                                                                                                                                                                                                                                                                                                                               |
| -------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Status         | Draft v1.1 (v0 archived at `docs/archive/PRD-v0-2026-04-25.md`; v1 in git history at commit `23455db`). Incorporates findings from `docs/threat-model-prd-v1.md` and `docs/output-quality-prd-v1.md`. Pending Karpathy review, then REVIEW-1 (`code-review`), REVIEW-2 (`legal-review` + `threat-model` + `privacy`), then adversarial review → v2. |
| Owner          | Mohammed Qazi (sirajuddin.qazi@gmail.com)                                                                                                                                                                                                                                                                                                           |
| Created        | 2026-04-25 (v0); revised 2026-04-26 (v1, v1.1)                                                                                                                                                                                                                                                                                                      |
